    ...
    <>
      ...
      <main className="flex-grow">
        <section className="relative bg-brand-teal-950 text-white pt-36 pb-20 overflow-hidden">
          ...
          <div className="absolute top-0 right-0 w-96 h-96 bg-brand-red-500/5 rounded-full blur-3xl pointer-events-none -mr-32 -mt-32" />

          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <span className="text-xs font-bold uppercase tracking-widest text-brand-red-400 block mb-4">
              Careers
            </span>
