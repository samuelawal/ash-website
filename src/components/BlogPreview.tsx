      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-16">
          ...
          >
            <Link
              href="#updates"
              className="inline-flex items-center gap-2 text-brand-teal-950 font-bold border-b-2 border-brand-teal-950 pb-1 hover:text-brand-gold-600 hover:border-brand-gold-600 transition-colors text-sm tracking-wide"
            >
              View All Articles
            </Link>
          </motion.div>
            ...
            >
              <div>
                ...
                <div className="relative aspect-[16/10] overflow-hidden bg-brand-teal-950">
                  ...
                  />
                  <div className="absolute top-4 left-4 bg-brand-gold-500 text-brand-teal-950 font-bold text-xs uppercase tracking-wider px-3 py-1 rounded-sm shadow-sm">
                    {post.category}
                  </div>
                </div>
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="flex gap-4 items-center text-xs text-brand-teal-900/60 font-medium">
                    ...
                    <span className="flex items-center gap-1">
                      <User className="w-3.5 h-3.5 text-brand-gold-600" />
                      {post.author}
                    </span>
                  </div>
              ...
              <div className="p-6 pt-0 mt-auto">
                <Link
                  href="#updates"
                  className="inline-flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider text-brand-teal-950 group-hover:text-brand-gold-600 transition-colors"
                >
                  Read Article
