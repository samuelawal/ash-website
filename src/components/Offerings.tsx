...
const iconMap = [
  <Zap key="zap" className="w-6 h-6 text-brand-red-500" />,
            ...
            >
              <div>
                ...
                <div className="flex justify-between items-start mb-6">
                  ...
                  <Link
                    href={item.link}
                    className="p-2 text-brand-teal-700 hover:text-brand-red-500 rounded-full hover:bg-brand-teal-100/40 transition-all opacity-40 group-hover:opacity-100 duration-200"
                ...
                <ul className="space-y-2 border-t border-brand-teal-100/30 pt-5 mb-8">
                  {item.details.map((detail) => (
                    <li key={detail} className="flex items-center gap-2 text-xs text-brand-teal-950 font-medium">
                      <span className="w-1.5 h-1.5 rounded-full bg-brand-red-500 shrink-0"></span>
                      {detail}
                    </li>
                  ))}
                </ul>
              ...
              {/* <Link
                href={item.link}
                className="text-xs font-bold uppercase tracking-wider text-brand-teal-700 group-hover:text-brand-red-600 transition-colors flex items-center gap-1"
              >
                Learn More
