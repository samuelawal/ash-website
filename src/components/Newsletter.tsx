...
export default function Newsletter() {
  ...
  return (
    <section className="py-24 bg-brand-teal-950 text-white relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-64 h-64 bg-brand-red-500/5 rounded-full blur-3xl pointer-events-none -ml-16 -mt-16"></div>
        ...
        <div className="max-w-md mx-auto">
          <AnimatePresence mode="wait">
            {!isSubmitted ? (
              ...
              >
                <div className="relative flex-grow">
                  ...
                  <input
                    ...
                    disabled={isLoading}
                    className="w-full bg-white/5 border border-white/10 focus:border-brand-red-500/70 focus:bg-white/10 outline-none rounded-sm py-3.5 pl-12 pr-4 text-sm text-white placeholder-white/30 transition-all font-medium"
                  />
                </div>
                <button
                  type="submit"
                  disabled={isLoading}
                  className="bg-brand-red-500 hover:bg-brand-red-600 active:scale-95 text-white font-bold px-6 py-3.5 rounded-sm transition-all text-sm tracking-wide shrink-0 flex items-center justify-center gap-1.5 shadow-lg shadow-brand-red-500/10 cursor-pointer disabled:opacity-75"
                >
                  {isLoading ? (
              ...
              >
                <div className="p-2.5 bg-brand-red-500/10 text-brand-red-500 rounded-full">
