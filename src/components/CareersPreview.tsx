          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            >
              <div className="flex items-start gap-4">
                <div className="p-3 bg-brand-gold-500/10 rounded-sm border border-brand-gold-500/20 shrink-0">
                  <Briefcase className="w-6 h-6 text-brand-gold-400" />
                </div>
                <div>
              ...
              <Link
                href="/careers"
                className="inline-flex items-center justify-center gap-2 bg-brand-gold-500 text-brand-teal-950 font-bold px-5 py-3 rounded-sm hover:bg-brand-gold-400 transition-colors text-sm tracking-wide shrink-0"
              >
                Browse All Roles
                <ArrowRight className="w-4 h-4" />
              </Link>
