          ...
          {data.items.map((project, index) => (
            ...
            >
              ...
              <div className="relative aspect-video overflow-hidden bg-brand-teal-950">
                ...
                {/* Top Left Tag */}
                <div className="absolute top-4 left-4 bg-brand-teal-950/80 backdrop-blur-md px-3 py-1.5 border border-brand-teal-800/40 rounded-sm text-xs font-semibold tracking-wide text-brand-gold-400">
                  {project.tag}
                </div>
              </div>
              ...
              <div className="p-6 sm:p-8 flex-grow flex flex-col justify-between space-y-6">
                <div className="space-y-3">
                  ...
                  <div className="flex flex-wrap gap-y-2 gap-x-6 text-sm text-brand-teal-900/70 font-medium">
                    ...
                    <span className="flex items-center gap-1.5">
                      <Zap className="w-4 h-4 text-brand-gold-500 shrink-0" />
                      {project.capacity}
                    </span>
                  </div>
                </div>
                ...
                <div className="pt-4 border-t border-brand-teal-100/30 flex justify-between items-center">
                  ...
                  <div className="p-2 bg-brand-teal-100/30 group-hover:bg-brand-gold-500 text-brand-teal-700 group-hover:text-white rounded-sm transition-all duration-300 shadow-sm border border-brand-teal-100/20">
