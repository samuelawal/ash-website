...
export default function CaseStudy() {
  ...
  return (
    <section className="py-24 bg-brand-teal-950 text-white overflow-hidden relative">
      ...
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-brand-red-500/5 rounded-full blur-3xl pointer-events-none -ml-32 -mb-32"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mb-16">
          <motion.span
            ...
            className="text-xs font-bold uppercase tracking-widest text-brand-red-400 block mb-2"
          >
            {data.subtitle}
          </motion.span>
          <motion.h2
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6 space-y-8">
            ...
            >
              <Quote className="w-10 h-10 text-brand-red-500/25 absolute top-4 left-4" />
          ...
          <div className="lg:col-span-6 space-y-10">
            ...
            <div className="grid grid-cols-2 gap-6">
              {data.metrics.map((metric, index) => (
                ...
                >
                  <span className="text-2xl sm:text-3xl font-extrabold font-display text-white block mb-1">
                    {metric.value}
                  </span>
            ...
            <div className="pt-4">
              <Link
                href="#contact"
                className="inline-flex items-center gap-2 text-brand-red-400 font-bold hover:text-brand-red-300 transition-colors uppercase tracking-wider text-xs"
              >
