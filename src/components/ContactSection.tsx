      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7">
            <form
              // No `onSubmit` preventDefault and no `name` attributes on the
              // fields: the form still has no backend, and this keeps its
              // current behaviour rather than silently changing it. The SDK
              // posts events with `keepalive`, so the event survives the
              // navigation the submit triggers.
              onSubmit={() =>
                trackEvent("contact_request_submitted", { service })
              }
